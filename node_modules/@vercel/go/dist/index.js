...
var require_is_stream = __commonJS({
  "../../node_modules/.pnpm/is-stream@1.1.0/node_modules/is-stream/index.js"(exports, module2) {
    "use strict";
    var isStream2 = module2.exports = function(stream) {
...
var require_pump = __commonJS({
  "../../node_modules/.pnpm/pump@3.0.2/node_modules/pump/index.js"(exports, module2) {
    ...
    var isFS = function(stream) {
      ...
      if (!fs11)
        return false;
      return (stream instanceof (fs11.ReadStream || noop3) || stream instanceof (fs11.WriteStream || noop3)) && isFn(stream.close);
    };
    var isRequest = function(stream) {
...
var require_errname = __commonJS({
  "../../node_modules/.pnpm/execa@1.0.0/node_modules/execa/lib/errname.js"(exports, module2) {
    ...
    if (typeof util.getSystemErrorName === "function") {
      ...
      module2.exports = (code2) => errname(uv, code2);
    }
    module2.exports.__test__ = errname;
    function errname(uv2, code2) {
      if (uv2) {
        return uv2.errname(code2);
      }
      if (!(code2 < 0)) {
        throw new Error("err >= 0");
      }
      return `Unknown system error ${code2}`;
    }
  }
});
...
var require_execa = __commonJS({
  "../../node_modules/.pnpm/execa@1.0.0/node_modules/execa/index.js"(exports, module2) {
    ...
    function makeError(result, options) {
      ...
      const { code: code2, signal } = result;
...
${stderr}${stdout}`;
        ...
        err.code = code2 < 0 ? errname(code2) : code2;
      }
      err.stdout = stdout;
      err.stderr = stderr;
      err.failed = true;
...
var require_dist = __commonJS({
  "../../node_modules/.pnpm/@tootallnate+once@1.1.2/node_modules/@tootallnate/once/dist/index.js"(exports, module2) {
    ...
    function once2(emitter, name2) {
      const o = once2.spread(emitter, name2);
    ...
    function patch(fs11) {
      ...
      function patchLutimes(fs12) {
        if (constants2.hasOwnProperty("O_SYMLINK") && fs12.futimes) {
          ...
          fs12.lutimes = function(_a7, _b7, _c7, cb) {
            if (cb)
              process.nextTick(cb);
          };
    ...
    function legacy(fs11) {
      ...
      function ReadStream2(path8, options) {
        if (!(this instanceof ReadStream2))
          return new ReadStream2(path8, options);
        Stream2.call(this);
        var self = this;
        this.path = path8;
        this.fd = null;
      ...
      function WriteStream2(path8, options) {
        if (!(this instanceof WriteStream2))
          return new WriteStream2(path8, options);
        Stream2.call(this);
        this.path = path8;
        this.fd = null;
        this.writable = true;
...
var require_utimes = __commonJS({
  "../../node_modules/.pnpm/fs-extra@7.0.1/node_modules/fs-extra/lib/util/utimes.js"(exports, module2) {
    ...
    function hasMillisResSync() {
      ...
      tmpfile = path8.join(os.tmpdir(), tmpfile);
      const d = /* @__PURE__ */ new Date(1435410243862);
      fs11.writeFileSync(tmpfile, "https://github.com/jprichardson/node-fs-extra/pull/141");
      const fd = fs11.openSync(tmpfile, "r+");
      fs11.futimesSync(fd, d, d);
      fs11.closeSync(fd);
      return fs11.statSync(tmpfile).mtime > 1435410243e3;
    }
    function hasMillisRes(callback) {
      let tmpfile = path8.join("millis-test" + Date.now().toString() + Math.random().toString().slice(2));
      tmpfile = path8.join(os.tmpdir(), tmpfile);
      const d = /* @__PURE__ */ new Date(1435410243862);
      fs11.writeFile(tmpfile, "https://github.com/jprichardson/node-fs-extra/pull/141", (err) => {
        if (err)
          return callback(err);
        fs11.open(tmpfile, "r+", (err2, fd) => {
          if (err2)
            return callback(err2);
          fs11.futimes(fd, d, d, (err3) => {
            if (err3)
              return callback(err3);
            fs11.close(fd, (err4) => {
              if (err4)
                return callback(err4);
              fs11.stat(tmpfile, (err5, stats) => {
                if (err5)
...
var require_copy_sync = __commonJS({
  "../../node_modules/.pnpm/fs-extra@7.0.1/node_modules/fs-extra/lib/copy-sync/copy-sync.js"(exports, module2) {
    ...
    function copyFile(srcStat, src, dest, opts) {
      if (typeof fs11.copyFileSync === "function") {
        fs11.copyFileSync(src, dest);
        fs11.chmodSync(dest, srcStat.mode);
    ...
    function copyFileFallback(srcStat, src, dest, opts) {
      ...
      const fdr = fs11.openSync(src, "r");
      const fdw = fs11.openSync(dest, "w", srcStat.mode);
      let pos2 = 0;
      while (pos2 < srcStat.size) {
        const bytesRead = fs11.readSync(fdr, _buff, 0, BUF_LENGTH, pos2);
        fs11.writeSync(fdw, _buff, 0, bytesRead);
        pos2 += bytesRead;
      }
      if (opts.preserveTimestamps)
        fs11.futimesSync(fdw, srcStat.atime, srcStat.mtime);
      fs11.closeSync(fdr);
      fs11.closeSync(fdw);
    }
    ...
    function mkDirAndCopy(srcStat, src, dest, opts) {
      ...
      return fs11.chmodSync(dest, srcStat.mode);
    }
    ...
    function onLink(destStat, src, dest, opts) {
      ...
      if (destStat === notExist) {
        ...
        if (fs11.statSync(dest).isDirectory() && isSrcSubdir(resolvedDest, resolvedSrc)) {
    ...
    function isSrcSubdir(src, dest) {
      const srcArray = path8.resolve(src).split(path8.sep);
      const destArray = path8.resolve(dest).split(path8.sep);
      return srcArray.reduce((acc, current, i) => acc && destArray[i] === current, true);
    }
    function checkStats(src, dest) {
      const srcStat = fs11.statSync(src);
      let destStat;
      try {
        destStat = fs11.statSync(dest);
      } catch (err) {
        if (err.code === "ENOENT")
...
var require_path_exists = __commonJS({
  "../../node_modules/.pnpm/fs-extra@7.0.1/node_modules/fs-extra/lib/path-exists/index.js"(exports, module2) {
    ...
    var fs11 = require_fs();
    function pathExists5(path8) {
      return fs11.access(path8).then(() => true).catch(() => false);
    }
    module2.exports = {
      pathExists: u(pathExists5),
...
var require_copy = __commonJS({
  "../../node_modules/.pnpm/fs-extra@7.0.1/node_modules/fs-extra/lib/copy/copy.js"(exports, module2) {
    ...
    function getStats(destStat, src, dest, opts, cb) {
      const stat = opts.dereference ? fs11.stat : fs11.lstat;
    ...
    function copyFile(srcStat, src, dest, opts, cb) {
      if (typeof fs11.copyFile === "function") {
        return fs11.copyFile(src, dest, (err) => {
          if (err)
            return cb(err);
    ...
    function copyFileFallback(srcStat, src, dest, opts, cb) {
      const rs = fs11.createReadStream(src);
      rs.on("error", (err) => cb(err)).once("open", () => {
        const ws = fs11.createWriteStream(dest, { mode: srcStat.mode });
        ws.on("error", (err) => cb(err)).on("open", () => rs.pipe(ws)).once("close", () => setDestModeAndTimestamps(srcStat, dest, opts, cb));
      });
    }
    function setDestModeAndTimestamps(srcStat, dest, opts, cb) {
      fs11.chmod(dest, srcStat.mode, (err) => {
        if (err)
          return cb(err);
        if (opts.preserveTimestamps) {
    ...
    function mkDirAndCopy(srcStat, src, dest, opts, cb) {
      fs11.mkdir(dest, (err) => {
        ...
        copyDir(src, dest, opts, (err2) => {
          if (err2)
            return cb(err2);
          return fs11.chmod(dest, srcStat.mode, cb);
        });
      });
    }
    ...
    function checkStats(src, dest, cb) {
      fs11.stat(src, (err, srcStat) => {
        if (err)
          return cb(err);
        fs11.stat(dest, (err2, destStat) => {
          if (err2) {
            if (err2.code === "ENOENT")
...
var require_rimraf = __commonJS({
  "../../node_modules/.pnpm/fs-extra@7.0.1/node_modules/fs-extra/lib/remove/rimraf.js"(exports, module2) {
    ...
    function rimraf(p, options, cb) {
      ...
      assert3.strictEqual(typeof p, "string", "rimraf: path should be a string");
      ...
      assert3.strictEqual(typeof options, "object", "rimraf: options should be object");
      defaults(options);
      ...
      options.lstat(p, (er, st) => {
        ...
        options.unlink(p, (er2) => {
          if (er2) {
            ...
            if (er2.code === "EPERM") {
              return isWindows4 ? fixWinEPERM(p, options, er2, cb) : rmdir2(p, options, er2, cb);
            }
            if (er2.code === "EISDIR") {
    ...
    function rmdir2(p, options, originalEr, cb) {
      ...
      assert3(options);
      if (originalEr) {
        assert3(originalEr instanceof Error);
      }
      assert3(typeof cb === "function");
      options.rmdir(p, (er) => {
...
var require_jsonfile = __commonJS({
  "../../node_modules/.pnpm/jsonfile@4.0.0/node_modules/jsonfile/index.js"(exports, module2) {
    ...
    function readFile4(file, options, callback) {
      ...
      options = options || {};
      var fs11 = options.fs || _fs;
      var shouldThrow = true;
      if ("throws" in options) {
        shouldThrow = options.throws;
      }
      fs11.readFile(file, options, function(err, data) {
        if (err)
          return callback(err);
        data = stripBom(data);
        var obj;
    ...
    function readFileSync(file, options) {
      ...
      try {
        var content = fs11.readFileSync(file, options);
    ...
    function writeFile3(file, obj, options, callback) {
      ...
      fs11.writeFile(file, str, options, callback);
    }
...
var require_move_sync = __commonJS({
  "../../node_modules/.pnpm/fs-extra@7.0.1/node_modules/fs-extra/lib/move-sync/index.js"(exports, module2) {
    ...
    function moveSync(src, dest, options) {
      ...
      src = path8.resolve(src);
      dest = path8.resolve(dest);
      if (src === dest)
        return fs11.accessSync(src);
      ...
      function tryRenameSync() {
        if (overwrite) {
          try {
            return fs11.renameSync(src, dest);
          } catch (err) {
          ...
          try {
            fs11.linkSync(src, dest);
            return fs11.unlinkSync(src);
          } catch (err) {
    ...
    function moveFileSyncAcrossDevice(src, dest, overwrite) {
      ...
      const fdr = fs11.openSync(src, "r");
      const stat = fs11.fstatSync(fdr);
      const fdw = fs11.openSync(dest, flags, stat.mode);
      let pos2 = 0;
    ...
    function isSrcSubdir(src, dest) {
      try {
        return fs11.statSync(src).isDirectory() && src !== dest && dest.indexOf(src) > -1 && dest.split(path8.dirname(src) + path8.sep)[1].split(path8.sep)[0] === path8.basename(src);
      } catch (e) {
        return false;
      }
    }
...
var require_move = __commonJS({
  "../../node_modules/.pnpm/fs-extra@7.0.1/node_modules/fs-extra/lib/move/index.js"(exports, module2) {
    ...
    function move2(src, dest, opts, cb) {
      ...
      dest = path8.resolve(dest);
      if (src === dest)
        return fs11.access(src, cb);
      fs11.stat(src, (err, st) => {
        if (err)
          return cb(err);
        if (st.isDirectory() && isSrcSubdir(src, dest)) {
          return cb(new Error(`Cannot move '${src}' to a subdirectory of itself, '${dest}'.`));
        }
        mkdirp3(path8.dirname(dest), (err2) => {
          if (err2)
            return cb(err2);
    ...
    function isSrcSubdir(src, dest) {
      const srcArray = src.split(path8.sep);
      const destArray = dest.split(path8.sep);
...
var require_fd_slicer = __commonJS({
  "../../node_modules/.pnpm/fd-slicer@1.1.0/node_modules/fd-slicer/index.js"(exports) {
    ...
    util.inherits(ReadStream2, Readable);
    ...
    util.inherits(WriteStream2, Writable);
  ...
  "../../node_modules/.pnpm/events-intercept@2.0.0/node_modules/events-intercept/lib/events-intercept.js"(exports, module2) {
    (function() {
      ...
      function removeInterceptor(type, interceptor) {
        ...
        list2 = this._interceptors[type];
        length = list2.length;
        position = -1;
        for (i = length - 1; i >= 0; i--) {
          if (list2[i] === interceptor) {
            position = i;
            break;
          }
        }
  ...
  "../../node_modules/.pnpm/yauzl-clone@1.0.4/node_modules/yauzl-clone/lib/index.js"(exports, module2) {
    ...
    function patch(yauzl2, methodName, fn) {
      ...
      if (methodName == "fromRandomAccessReader") {
        ...
        const shimmed = fn(function(path8, unused, options, callback) {
          return original.call(this, path8, options, callback);
        });
        yauzl2[methodName] = function(path8, options, callback) {
          if (typeof options == "function") {
            callback = options;
            options = {};
          } else if (!options) {
          ...
          return shimmed.call(this, path8, null, options, callback);
        };
      }
      return yauzl2[methodName];
    }
    function zipFilePatcher(original, ZipFile) {
      return function(path8, totalSize, options, callback) {
        const { lazyEntries } = options, hasLazyEntries = options.hasOwnProperty("lazyEntries");
        if (!lazyEntries)
          options.lazyEntries = true;
        return original.call(this, path8, totalSize, options, function(err, zipFile) {
          if (err)
            return callback(err);
  ...
  "../../node_modules/.pnpm/yauzl-promise@2.1.3/node_modules/yauzl-promise/lib/promisify.js"(exports, module2) {
    ...
    function promisifyMethod(yauzl2, Promise2, fnName) {
      ...
      cloner.patch(yauzl2, fnName, (original) => {
        return function(path8, totalSize, options) {
          return new Promise2((resolve, reject) => {
            options = Object.assign({}, options, { lazyEntries: true, autoClose: false });
            original(path8, totalSize, options, (err, zipFile) => {
              if (err)
                return reject(err);
    ...
    function getState(zipFile) {
      return zipFile[STATE2];
    }
    function setState(zipFile, state) {
      zipFile[STATE2] = state;
    }
    function clearState(zipFile) {
      zipFile[STATE2] = void 0;
    }
...
var require_lib7 = __commonJS({
  "../../node_modules/.pnpm/os-paths@4.4.0/node_modules/os-paths/src/lib/index.js"(exports, module2) {
    ...
    function normalize_path(path8) {
      return paths.normalize(paths.join(path8, "."));
    }
    var base = () => {
      const { env } = process;
      const object = {};
...
var require_lib8 = __commonJS({
  "../../node_modules/.pnpm/xdg-portable@7.3.0/node_modules/xdg-portable/src/lib/index.js"(exports, module2) {
    ...
    var linux = () => {
      const object = {};
      object.cache = () => process.env.XDG_CACHE_HOME || path8.join(osPaths.home() || osPaths.temp(), ".cache");
      object.config = () => process.env.XDG_CONFIG_HOME || path8.join(osPaths.home() || osPaths.temp(), ".config");
      object.data = () => process.env.XDG_DATA_HOME || path8.join(osPaths.home() || osPaths.temp(), ".local", "share");
      object.runtime = () => process.env.XDG_RUNTIME_DIR || void 0;
      object.state = () => process.env.XDG_STATE_HOME || path8.join(osPaths.home() || osPaths.temp(), ".local", "state");
      return object;
    };
    var macos = () => {
      const object = {};
      object.cache = () => process.env.XDG_CACHE_HOME || path8.join(path8.join(osPaths.home() || osPaths.temp(), "Library"), "Caches");
      object.config = () => process.env.XDG_CONFIG_HOME || path8.join(path8.join(osPaths.home() || osPaths.temp(), "Library"), "Preferences");
      object.data = () => process.env.XDG_DATA_HOME || path8.join(path8.join(osPaths.home() || osPaths.temp(), "Library"), "Application Support");
      object.runtime = () => process.env.XDG_RUNTIME_DIR || void 0;
      object.state = () => process.env.XDG_STATE_HOME || path8.join(path8.join(osPaths.home() || osPaths.temp(), "Library"), "State");
      return object;
    };
    var windows = () => {
      const object = {};
      object.cache = () => {
        const localAppData = process.env.LOCALAPPDATA || path8.join(osPaths.home() || osPaths.temp(), "AppData", "Local");
        return process.env.XDG_CACHE_HOME || path8.join(localAppData, "xdg.cache");
      };
      object.config = () => {
        const appData = process.env.APPDATA || path8.join(osPaths.home() || osPaths.temp(), "AppData", "Roaming");
        return process.env.XDG_CONFIG_HOME || path8.join(appData, "xdg.config");
      };
      object.data = () => {
        const appData = process.env.APPDATA || path8.join(osPaths.home() || osPaths.temp(), "AppData", "Roaming");
        return process.env.XDG_DATA_HOME || path8.join(appData, "xdg.data");
      };
      object.runtime = () => process.env.XDG_RUNTIME_DIR || void 0;
      object.state = () => {
        const localAppData = process.env.LOCALAPPDATA || path8.join(osPaths.home() || osPaths.temp(), "AppData", "Local");
        return process.env.XDG_STATE_HOME || path8.join(localAppData, "xdg.state");
      };
      return object;
    };
    var _XDGPortable = () => {
      ...
      extension.configDirs = () => {
        ...
        if (process.env.XDG_CONFIG_DIRS) {
          dirs.push(...process.env.XDG_CONFIG_DIRS.split(path8.delimiter));
        }
        return dirs;
      };
      extension.dataDirs = () => {
        ...
        if (process.env.XDG_DATA_DIRS) {
          dirs.push(...process.env.XDG_DATA_DIRS.split(path8.delimiter));
        }
        return dirs;
      };
      Object.keys(extension).forEach((key) => {
...
var require_xdg_app_paths = __commonJS({
  "../../node_modules/.pnpm/xdg-app-paths@5.1.0/node_modules/xdg-app-paths/index.js"(exports, module2) {
    ...
    var base = (name2, isolated) => {
      const object = {};
      object.cache = (options = { isolated: null }) => {
        options = _normalizeOptions(options, isolated);
        return path8.join(xdg.cache(), options.isolated ? name2 : "");
      };
      object.config = (options = { isolated: null }) => {
        options = _normalizeOptions(options, isolated);
        return path8.join(xdg.config(), options.isolated ? name2 : "");
      };
      object.data = (options = { isolated: null }) => {
        options = _normalizeOptions(options, isolated);
        return path8.join(xdg.data(), options.isolated ? name2 : "");
      };
      object.runtime = (options = { isolated: null }) => {
        options = _normalizeOptions(options, isolated);
        return xdg.runtime() ? path8.join(xdg.runtime(), options.isolated ? name2 : "") : void 0;
      };
      object.state = (options = { isolated: null }) => {
        options = _normalizeOptions(options, isolated);
        return path8.join(xdg.state(), options.isolated ? name2 : "");
      };
      object.configDirs = (options = { isolated: null }) => {
        options = _normalizeOptions(options, isolated);
        return xdg.configDirs().map((s) => path8.join(s, options.isolated ? name2 : ""));
      };
      object.dataDirs = (options = { isolated: null }) => {
        options = _normalizeOptions(options, isolated);
        return xdg.dataDirs().map((s) => path8.join(s, options.isolated ? name2 : ""));
      };
      return object;
    };
    var windows = (name2, isolated) => {
      const { env } = process;
      const homedir2 = os.homedir();
      const tmpdir3 = os.tmpdir();
      const appData = env.APPDATA || path8.join(homedir2 || tmpdir3, "AppData", "Roaming");
      const localAppData = env.LOCALAPPDATA || path8.join(homedir2 || tmpdir3, "AppData", "Local");
      const object = {};
      object.cache = (options = { isolated: null }) => {
        options = _normalizeOptions(options, isolated);
        return !options.isolated || env.XDG_CACHE_HOME ? path8.join(xdg.cache(), options.isolated ? name2 : "") : path8.join(localAppData, options.isolated ? name2 : "", "Cache");
      };
      object.config = (options = { isolated: null }) => {
        options = _normalizeOptions(options, isolated);
        const config = !options.isolated || env.XDG_CONFIG_HOME ? path8.join(xdg.config(), options.isolated ? name2 : "") : path8.join(appData, options.isolated ? name2 : "", "Config");
        return config;
      };
      object.data = (options = { isolated: null }) => {
        options = _normalizeOptions(options, isolated);
        const data = !options.isolated || env.XDG_DATA_HOME ? path8.join(xdg.data(), options.isolated ? name2 : "") : path8.join(appData, options.isolated ? name2 : "", "Data");
        return data;
      };
      object.runtime = (options = { isolated: null }) => {
        options = _normalizeOptions(options, isolated);
      ...
      object.state = (options = { isolated: null }) => {
        options = _normalizeOptions(options, isolated);
        return !options.isolated || env.XDG_STATE_HOME ? path8.join(xdg.state(), options.isolated ? name2 : "") : path8.join(localAppData, options.isolated ? name2 : "", "State");
      };
      object.configDirs = (options = { isolated: null }) => {
        options = _normalizeOptions(options, isolated);
        const dirs = [object.config(options)];
        if (env.XDG_CONFIG_DIRS) {
          dirs.push(...env.XDG_CONFIG_DIRS.split(path8.delimiter).map((s) => path8.join(s, options.isolated ? name2 : "")));
        }
        return dirs;
      };
      object.dataDirs = (options = { isolated: null }) => {
        ...
        if (env.XDG_DATA_DIRS) {
          dirs.push(...env.XDG_DATA_DIRS.split(path8.delimiter).map((s) => path8.join(s, options.isolated ? name2 : "")));
        }
        return dirs;
      };
      return object;
    ...
    var _XDGAppPaths = class __XDGAppPaths {
      constructor(options = { name: null, suffix: null, isolated: true }) {
        ...
        let name2 = options.name || "";
        if (typeof name2 !== "string") {
          throw new TypeError(`Expected string for "name" argument, got ${typeof name2}`);
        }
        ...
        if (!name2) {
          name2 = path8.parse(process.pkg ? process.execPath : require.main ? require.main.filename : process.argv[0]).name;
        }
        if (suffix) {
          name2 += suffix;
        }
        ...
        const extension = isWinOS ? windows(name2, isolated) : base(name2, isolated);
        Object.keys(extension).forEach((key) => {
          this._fn[key] = extension[key];
        });
        return this._fn;
...
var Minipass = class extends import_node_events.EventEmitter {
  ...
  [(_a = FLOWING, _b = PAUSED, _c = PIPES, _d = BUFFER, _e = OBJECTMODE, _f = ENCODING, _g = ASYNC, _h = DECODER, _i = EOF, _j = EMITTED_END, _k = EMITTING_END, _l = CLOSED, _m = EMITTED_ERROR, _n = BUFFERLENGTH, _o = DESTROYED, _p = SIGNAL, _q = ABORTED, _r = DATALISTENERS, _s = DISCARDED, ABORT)]() {
    this[ABORTED] = true;
...
var ReadStream = class extends Minipass {
  ...
  [(_a2 = _errored, _b2 = _fd, _c2 = _path, _d2 = _readSize, _e2 = _reading, _f2 = _size, _g2 = _remain, _h2 = _autoClose, _open)]() {
...
var _a3, _b3, _c3, _d3, _e3, _f3, _g3, _h3, _i2, _j2, _k2, _l2, _m2;
var WriteStream = class extends import_events.default {
  ...
  [(_a3 = _errored, _b3 = _writing, _c3 = _ended, _d3 = _queue, _e3 = _needDrain, _f3 = _path, _g3 = _mode, _h3 = _autoClose, _i2 = _fd, _j2 = _defaultFlag, _k2 = _flags, _l2 = _finished, _m2 = _pos, _onerror)](er) {
    this[_close]();
    this[_writing] = true;
    this.emit("error", er);
  }
...
var ZlibBase = class extends Minipass {
  ...
  constructor(opts, mode) {
    ...
    __privateAdd(this, _flushFlag2, void 0);
    __privateAdd(this, _finishFlushFlag, void 0);
    __privateAdd(this, _fullFlushFlag, void 0);
  ...
  reset() {
    if (!__privateGet(this, _sawError)) {
      (0, import_assert.default)(__privateGet(this, _handle), "zlib binding closed");
      return __privateGet(this, _handle).reset?.();
    }
  }
  flush(flushFlag) {
    if (this.ended)
  ...
  write(chunk, encoding, cb) {
    ...
    try {
      ...
      passthroughBufferConcat(false);
      __privateGet(this, _onError).call(this, new ZlibError(err, this.write));
    } finally {
      if (__privateGet(this, _handle)) {
        ;
    ...
    if (__privateGet(this, _handle))
      __privateGet(this, _handle).on("error", (er) => __privateGet(this, _onError).call(this, new ZlibError(er, this.write)));
    let writeReturn;
    if (result) {
...
var Gzip = class extends Zlib {
  constructor(opts) {
    super(opts, "Gzip");
    __privateAdd(this, _portable, void 0);
...
var _slurp2, slurp_fn2;
var ReadEntry = class extends Minipass {
  constructor(header, ex, gex) {
    super({});
    __privateAdd(this, _slurp2);
    ...
    this.gname = header.gname;
    if (ex) {
      __privateMethod(this, _slurp2, slurp_fn2).call(this, ex);
    }
    if (gex) {
      __privateMethod(this, _slurp2, slurp_fn2).call(this, gex, true);
    }
  }
  write(data) {
...
var noop2 = () => true;
var _a4, _b4, _c4, _d4, _e4, _f4, _g4, _h4, _i3, _j3, _k3, _l3, _m3, _n2, _o2, _p2, _q2;
var Parser = class extends import_events2.EventEmitter {
  ...
  [(_a4 = QUEUE, _b4 = BUFFER2, _c4 = READENTRY, _d4 = WRITEENTRY, _e4 = STATE, _f4 = META, _g4 = EX, _h4 = GEX, _i3 = ENDED, _j3 = UNZIP, _k3 = ABORTED2, _l3 = SAW_VALID_ENTRY, _m3 = SAW_NULL_BLOCK, _n2 = SAW_EOF, _o2 = WRITING, _p2 = CONSUMING, _q2 = EMITTEDEND, CONSUMEHEADER)](chunk, position) {
...
var Pack = class extends Minipass {
  ...
  [(_a5 = WRITEENTRYCLASS, _b5 = QUEUE2, _c5 = JOBS, _d5 = PROCESSING, _e5 = ENDED2, WRITE)](chunk) {
...
var mkdir = (dir, opt, cb) => {
  ...
  mkdir_(cwd, parts, mode, unlink2, cwd, void 0, done);
};
var mkdir_ = (base, parts, mode, unlink2, cwd, created, cb) => {
  ...
  import_node_fs3.default.mkdir(part, mode, onmkdir(part, parts, mode, unlink2, cwd, created, cb));
};
...
var _queues, _reservations, _running, _getQueues, getQueues_fn, _run, run_fn, _clear, clear_fn;
var PathReservations = class {
  ...
  reserve(paths, fn) {
    ...
    for (const dir of dirs) {
      ...
      if (!q) {
        __privateGet(this, _queues).set(dir, [/* @__PURE__ */ new Set([fn])]);
      } else {
    ...
    return __privateMethod(this, _run, run_fn).call(this, fn);
  }
  // check if fn is first in line for all its paths, and is
  // included in the first set for all its dir queues
  check(fn) {
    const { paths, dirs } = __privateMethod(this, _getQueues, getQueues_fn).call(this, fn);
...
getQueues_fn = function(fn) {
  ...
  return {
    paths: res.paths.map((path8) => __privateGet(this, _queues).get(path8)),
    dirs: [...res.dirs].map((path8) => __privateGet(this, _queues).get(path8))
  };
};
_run = new WeakSet();
run_fn = function(fn) {
  ...
  fn(() => __privateMethod(this, _clear, clear_fn).call(this, fn));
  return true;
};
_clear = new WeakSet();
clear_fn = function(fn) {
  ...
  for (const path8 of paths) {
    const q = __privateGet(this, _queues).get(path8);
    if (!q || q?.[0] !== fn) {
      continue;
    }
    const q0 = q[1];
    if (!q0) {
      __privateGet(this, _queues).delete(path8);
      continue;
    }
    q.shift();
  ...
  next.forEach((fn2) => __privateMethod(this, _run, run_fn).call(this, fn2));
  return true;
};
...
var Unpack = class extends Parser {
  constructor(opt = {}) {
    ...
    __publicField(this, "reservations", new PathReservations());
  ...
  [(_a6 = ENDED3, _b6 = CHECKED_CWD, _c6 = PENDING, MAYBECLOSE)]() {
...
var mtimeFilter = (opt) => {
  ...
  opt.filter = filter ? (path8, stat) => filter(path8, stat) && !/* c8 ignore start */
...
function getGoUrl(version2) {
  const { arch, platform: platform5 } = process;
  const ext = platform5 === "win32" ? "zip" : "tar.gz";
  const goPlatform = platformMap.get(platform5) || platform5;
  let goArch = archMap.get(arch) || arch;
  if (platform5 === "darwin" && goArch === "arm64" && parseInt(/^\d+.(\d+)/.exec(version2)[1], 10) < 16) {
    goArch = "amd64";
  }
...
async function createGo({
  ...
  const goGlobalCacheDir = (0, import_path4.join)(
    goGlobalCachePath,
    `${goSelectedVersion}_${platform5}_${process.arch}`
  );
...
async function download({ dest, version: version2 }) {
  ...
  await new Promise((resolve, reject) => {
    res.body.on("error", reject).pipe(extract({ cwd: dest, strip: 1 })).on("error", reject).on("finish", resolve);
  });
}
...
async function startStandaloneDevServer(opts, resolvedEntrypoint) {
  ...
  const child = (0, import_child_process.spawn)("go", ["run", runTarget], {
    cwd: workPath,
    env,
...
async function writeGoWork(destDir, workPath, modulePath) {
  ...
  if (goWorkPath) {
    ...
    const addPath = (path8) => {
      if (path8) {
        if (path8.startsWith(".")) {
          workspaces.add((0, import_path7.relative)(destDir, (0, import_path7.join)(workPath, path8)));
        } else {
          workspaces.add(path8);
        }
      }
    };
...
async function prepareCache({
  ...
  const cache2 = await (0, import_build_utils4.glob)(`${localCacheDir}/**`, workPath);
  return cache2;
}
